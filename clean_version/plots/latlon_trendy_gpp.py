...
def trendy_spatial(fig, ax, value, obj, period):
    ...
    return ax
print(__name__)
if __name__.split('.')[-1] == 'latlon_trendy_gpp':
    ...
    p_mean  = get_mean(data.trendy['gpp'].spatial, spatial_period) * 86400 * 1000
    s_mean  = get_season_mean(data.trendy['gpp'].spatial, spatial_period, season) * 86400 * 1000
    if season_mod:
        for model in models:
            ...
            if len(models) >= 9:
                savepath = '/home/mhuang/output/GPP_map/'
